...
class Subscription extends Model
{
    ...
    public function plan()
    {
        ...
        return $this->belongsTo('\Worker\Model\Plan', 'plan_id', 'uid');
    }
    ...
    {
        // @todo dependency injection
        return $this->belongsTo('\Worker\Model\Customer', 'user_id', 'uid');
    }
    ...
    {
        // @todo dependency injection
        return $this->hasMany('\Worker\Cashier\SubscriptionTransaction');
    }
    ...
    {
        // @todo dependency injection
        return $this->hasMany('\Worker\Cashier\SubscriptionLog');
    }
    ...
    {
        return \Worker\Cashier\Cashier::getPaymentGateway($this->gateway);
    }
