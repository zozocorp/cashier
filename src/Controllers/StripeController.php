...
use Worker\Cashier\Services\StripePaymentGateway;
...
class StripeController extends Controller
{
    ...
    public function checkout(Request $request, $subscription_id)
    {
        ...
        if (isSiteDemo()) {
            if ($subscription->plan->price == 0) {
                ...
                return redirect()->away(Cashier::lr_action('\Worker\Http\Controllers\AccountSubscriptionController@selectPlan'));
            }
            ...
            $session = \Stripe\Checkout\Session::create([
                ...
                'line_items' => [[
                  ...
                  'description' => \Worker\Model\Setting::get('site_name'),
                ...
                'cancel_url' => \Worker\Cashier\Cashier::lr_action('\Worker\Http\Controllers\AccountSubscriptionController@index'),
            ]);
    ...
    public function changePlan(Request $request, $subscription_id)
    {
        ...
        $newPlan = \Worker\Model\Plan::findByUid($request->plan_id);
