...
class DirectController extends Controller
{
    ...
    public function claim(Request $request, $subscription_id)
    {
        ...
        return redirect()->away(Cashier::wp_action('\Worker\Cashier\Controllers\DirectController@pending', [
    ...
    public function unclaim(Request $request, $subscription_id)
    {
        ...
        return redirect()->away(Cashier::wp_action('\Worker\Cashier\Controllers\DirectController@checkout', [
            'subscription_id' => $subscription->uid,
        ]));
    }
    ...
    public function pending(Request $request, $subscription_id)
    {
        ...
        if ($transaction->type == SubscriptionTransaction::TYPE_RENEW) {
            ...
            $plan = \Worker\Model\Plan::findByUid($transaction->getMetadata()['plan_id']);
    ...
    public function pendingClaim(Request $request, $subscription_id)
    {
        ...
        return redirect()->away(Cashier::lr_action('\Worker\Cashier\Controllers\DirectController@pending', [
            'subscription_id' => $subscription->uid,
        ]));
    }
            ...
            if ($subscription->plan->getBillableAmount() == 0) {
                ...
                $subscription->error = json_encode([
                    ...
                    'message' => trans('cashier::messages.direct.has_transaction_pending', [
                        ...
                        'url' => \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\DirectController@pending', [
                            'subscription_id' => $subscription->uid,
                        ]),
                    ]),
                ]);
