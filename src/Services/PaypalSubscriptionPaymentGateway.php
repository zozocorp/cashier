...
class PaypalSubscriptionPaymentGateway implements PaymentGatewayInterface
{
    ...
    public function removePayPalProduct()
    {
        ...
        foreach ($data['plans'] as $key => $connection) {
            ...
            if ($connection['paypal_id']) {
                $plan = \Worker\Model\Plan::findByUid($connection['uid']);
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\PaypalSubscriptionController@renew", [
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\PaypalSubscriptionController@changePlan", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
            'plan_id' => $plan_id,
        ]);
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\PaypalSubscriptionController@pending", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\PaypalSubscriptionController@transactionPending", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\PaypalSubscriptionController@ChangePlanpending", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
