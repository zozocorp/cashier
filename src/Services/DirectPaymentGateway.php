...
class DirectPaymentGateway implements PaymentGatewayInterface {
            ...
            if ($subscription->isExpiring() && $subscription->canRenewPlan()) {
                $subscription->error = json_encode([
                    ...
                    'message' => trans('cashier::messages.renew.warning', [
                        ...
                        'link' => \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\DirectController@renew", [
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\DirectController@pending", [
            'subscription_id' => $subscription->uid,
    ...
    public function getCheckoutUrl($subscription, $returnUrl='/') {
        return \Worker\Cashier\Cashier::wp_action("\Worker\Cashier\Controllers\DirectController@checkout", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\DirectController@changePlan", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
            'plan_id' => $plan_id,
        ]);
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\DirectController@renew", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
