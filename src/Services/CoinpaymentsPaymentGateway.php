...
use Worker\Cashier\Library\CoinPayment\CoinpaymentsAPI;
...
class CoinpaymentsPaymentGateway implements PaymentGatewayInterface
{
            ...
            if ($subscription->isExpiring() && $subscription->canRenewPlan()) {
                $subscription->error = json_encode([
                    ...
                    'message' => trans('cashier::messages.renew.warning', [
                        ...
                        'link' => \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\CoinpaymentsController@renew", [
    ...
    //         'url' => \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\CoinpaymentsController@transactionPending', [
    //             'subscription_id' => $subscription->uid,
    //         ]),
    //     ]);
    // }
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\CoinpaymentsController@renew", [
            'subscription_id' => $subscription->uid,
    ...
    public function getCheckoutUrl($subscription, $returnUrl='/') {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\CoinpaymentsController@checkout", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\CoinpaymentsController@changePlan", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
            'plan_id' => $plan_id,
        ]);
    ...
    {
        return \Worker\Cashier\Cashier::lr_action("\Worker\Cashier\Controllers\\CoinpaymentsController@pending", [
            'subscription_id' => $subscription->uid,
            'return_url' => $returnUrl,
        ]);
    }
