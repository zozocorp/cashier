    ...
    <body>
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                @if ($newPlan->price == 0)
                    <form method="POST" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\RazorpayController@changePlan', ['subscription_id' => $subscription->uid]) }}">
                        {{ csrf_field() }}
                ...
                @else
                    ...
                    <div class="hide" style="display:none">
                        <form action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\RazorpayController@changePlan', [
                        '_token' => csrf_token(),
