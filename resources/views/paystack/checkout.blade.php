    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">                
                    ...
                    function payWithPaystack() {
                        var handler = PaystackPop.setup({
                            ...
                            callback: function(response) {
                                ...
                                var url = '{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\PaystackController@checkout', [
                ...
                <form class="mt-5" method="POST" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\PaystackController@cancelNow', ['subscription_id' => $subscription->uid]) }}">
                    {{ csrf_field() }}
