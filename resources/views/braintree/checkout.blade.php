    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Worker\Cashier\Cashier::public_url('/vendor/ema-cashier/image/braintree.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">                
                ...
                @if ($cardInfo !== NULL)
                    <div class="sub-section mb-5">
                        ...
                        <a style="width: 100%;" href="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@charge', [
                ...
                <form method="POST" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@cancelNow', ['subscription_id' => $subscription->uid]) }}">
                    {{ csrf_field() }}
                ...
                <form id="updateCard" style="display: none" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@updateCard', [
                    'subscription_id' => $subscription->uid,
                ]) }}" method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" name="nonce" value="" />
                    <input type="hidden" name="redirect" value="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@charge', [
                        'subscription_id' => $subscription->uid,
                    ]) }}" />
                </form>
