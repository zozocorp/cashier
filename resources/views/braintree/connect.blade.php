    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Worker\Cashier\Cashier::public_url('/vendor/acelle-cashier/image/braintree.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">
                ...
                @if ($cardInfo !== NULL)
                    <div class="sub-section mb-5">
                        ...
                        <form
                            action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@connect') }}" method="POST">
                            {{ csrf_field() }}
