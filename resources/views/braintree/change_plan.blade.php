    ...
    <body>
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img width="100%" src="{{ \Worker\Cashier\Cashier::public_url('/vendor/ema-cashier/image/braintree.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">
                ...
                @if ($newPlan->price == 0)
                    <a href="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@changePlanPending', [
                ...
                @if ($newPlan->price > 0)
                    ...
                    <form id="updateCard" style="display: none" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@updateCard', [
                        ...
                        <input type="hidden" name="redirect" value="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@changePlanPending', [
                            'subscription_id' => $subscription->uid,
                            'plan_id' => $newPlan->getBillableId(),
                        ]) }}" />
                    </form>
