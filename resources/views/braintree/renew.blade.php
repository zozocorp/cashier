                ...
                @if ($subscription->plan->price > 0)
                    ...
                    @if ($cardInfo !== NULL)
                        <div class="sub-section mb-5">
                            ...
                            <a href="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@renewPending', [
                    ...
                    <form id="updateCard" style="display: none" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@updateCard', [
                        ...
                        <input type="hidden" name="charge_url" value="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@renewPending', [
                            'subscription_id' => $subscription->uid,
                        ]) }}" />
                    </form>
