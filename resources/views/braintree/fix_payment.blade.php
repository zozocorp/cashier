        ...
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">                
                ...
                <form id="updateCard" style="display: none" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@updateCard', [
                    ...
                    <input type="hidden" name="redirect" value="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@paymentRedirect', [
                        'redirect' => \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\BraintreeController@fixPayment', [
                            'subscription_id' => $subscription->uid,
                        ]),
                    ]) }}" />
                </form>
