        ...
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                @if ($newPlan->getBillableAmount() == 0)
                    <form method="POST" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\PaypalController@changePlan', ['subscription_id' => $subscription->uid]) }}">
                        {{ csrf_field() }}
                    ...
                    <script>
                        ...
                        paypal.Buttons({
                            ...
                            onApprove: function(data, actions) {
                                ...
                                form.append(jQuery('<input>', {
                                    'name': 'redirect',
                                    'value': '{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\PaypalSubscriptionController@changePlan', $subscription->uid) }}',
                                    'type': 'hidden'
                                }));
                                form.submit();
                            }
