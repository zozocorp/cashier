...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form method="POST" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\DirectController@pendingUnclaim', [
            ...
            <br>
                <form class="mt-4" method="POST" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\DirectController@cancelNow', ['subscription_id' => $subscription->uid]) }}">
                    {{ csrf_field() }}
