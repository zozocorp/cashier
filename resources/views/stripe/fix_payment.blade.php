        ...
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">                
                ...
                <div class="sub-section">
                    ...
                    <form id="stripe_button" style="" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\StripeController@fixPayment', [
                            '_token' => csrf_token(),
                ...
                <form id="stripe_button" style="display: none" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\StripeController@updateCard', [
                    ...
                    <input type="hidden" name="redirect" value="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\StripeController@paymentRedirect', [
                        'redirect' => \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\StripeController@fixPayment', [
                            'subscription_id' => $subscription->uid,
                        ]),
                    ]) }}" />
                ...
                <a
                    href="{{ \Worker\Cashier\Cashier::lr_action('AccountSubscriptionController@index') }}"
