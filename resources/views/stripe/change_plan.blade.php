    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">                
                ...
                @if($amount == 0)
                    <a href="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\StripeController@changePlanPending', [
                ...
                <form id="stripe_button" style="display: none" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\StripeController@updateCard', [
                    ...
                    <input type="hidden" name="redirect" value="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\StripeController@changePlanPending', [
                        'subscription_id' => $subscription->uid,
                        'plan_id' => $newPlan->getBillableId(),
                    ]) }}" />
