        ...
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <div class="sub-section">
                    @if ($cardInfo !== NULL)
                        ...
                        <form id="stripe_button"
                            action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\StripeController@connect') }}" method="POST">
                            {{ csrf_field() }}
                ...
                <form id="stripe_button" style="display:none"
                    action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\StripeController@connect', [
                    '_token' => csrf_token(),
                ]) }}" method="POST">
