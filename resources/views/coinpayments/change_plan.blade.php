    ...
    <body>
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <form method="POST" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\CoinpaymentsController@changePlan', ['subscription_id' => $subscription->uid]) }}">
                    {{ csrf_field() }}
