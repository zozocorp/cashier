        ...
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pl-20 pd-60">
                ...
                <div class="logo-wrapper">
                    <img width="100%" src="{{ \Worker\Cashier\Cashier::public_url('/vendor/ema-cashier/image/coinpayments.png') }}" />
                </div>
            </div>
            <div class="col-md-4 mt-40 pd-60">
                ...
                {{-- @if (!$transaction) --}}
                    ...
                    <a href="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\CoinpaymentsController@charge', [
                        'subscription_id' => $subscription->uid,
                    ]) }}" class="btn btn-secondary">{{ trans('cashier::messages.coinpayments.pay_now') }}</a>
                    
                    <form class="mt-5" method="POST" action="{{ \Worker\Cashier\Cashier::lr_action('\Worker\Cashier\Controllers\CoinpaymentsController@cancelNow', ['subscription_id' => $subscription->uid]) }}">
                        {{ csrf_field() }}
